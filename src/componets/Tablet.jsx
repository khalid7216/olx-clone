...
function Tablet() {
  return (
 <>
   <div className="p-6"><h1 className='p-1 text-xl font-bold text-cyan-950 '>Tablets</h1>
          ...
          <div key={i} className="w-full border border-gray-300 bg-white">
            ...
            <div className="border-t border-gray-300 p-2">
              <p className="text-xl font-bold flex justify-between items-center">
                <span className="text-cyan-950">Rs 1.09 Lac</span>
          <FaRegHeart />
              </p>
              ...
              <p className="text-gray-500 mt-1">
                Johar Town, Lahore <br /> 4 days ago
              </p>
            </div>
          </div>
        ))}
