...
function Sample() {
  return (
    <div className="p-6"><h1 className='p-1 text-xl font-bold text-cyan-950 '>Mobile phones</h1>
          ...
          <div key={i} className="w-full border border-gray-300 bg-white">
            ...
            <div className="border-t border-gray-300 p-2">
              <p className="text-xl font-bold flex justify-between items-center">
                <span className="text-cyan-950">RS 69,000</span>
               <FaRegHeart />
              </p>
              <p className="text-sm mt-1 text-cyan-950">
                iPhone 12 Variants 64GB, 128GB, 256GB available. If you want buy..
              </p>
              <p className="text-gray-500 mt-1">
                Sadar, Karachi <br /> 3 Days ago
              </p>
            </div>
          </div>
        ))}
